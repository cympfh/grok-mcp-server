...
わたくし、X (Twitter) のリアルタイム情報検索と画像生成・編集・理解を xAI の Grok さんにお願いできる MCP サーバーですわ。
...
5. **画像理解**: 画像の内容を理解して説明してもらえます（Grok Vision API）

Grok の検索能力と画像処理能力を Claude に追加できるので、リアルタイムの情報が必要なときやビジュアルコンテンツを扱いたいときに便利ですの。
...
こちらもファイルパス、URL、base64データのいずれかで画像を指定できますわよ。Grok Vision API を使って高精度な画像理解ができますの。
...
5. **image_understanding**: 画像の内容理解と説明
